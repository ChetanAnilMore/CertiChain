...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
        ...
        $sql = "INSERT INTO `indi`(`fname`, `lname`, `pnumber`, `email`, `password`) VALUES ('$fname','$lname','$pnumber','$email','$password')";
        $sql1 = "CREATE TABLE `$email`(id INT AUTO_INCREMENT PRIMARY KEY, file LONGBLOB)";
...
<body>
    <div class="container1">
        ...
        <form id="user_form" method="POST">
            ...
            <center>
                <input class="btn-primary" type="submit" name="submit" value="Submit" href="D:\eih project\website\index1.html"class="button">
            </center>
        </form>
    </div>
</body>
